...
% Change ToC link color
{\hypersetup{linkcolor=black, linkbordercolor=black} \tableofcontents}
...
\clearpage
\addcontentsline{toc}{section}{Supplementary Materials A - Original Study}
\section*{Supplementary Materials A}
\setcounter{figure}{0}
\setcounter{table}{0}
...
\clearpage
\addcontentsline{toc}{subsection}{Reversal learning task instructions}
...
\addcontentsline{toc}{subsection}{Model-based analyses of C/IE behavior}
...
\break
\addcontentsline{toc}{section}{Supplementary Materials B - Replication Study}
...
\addcontentsline{toc}{subsubsection}{Self-report measures}
...
\addcontentsline{toc}{subsubsection}{Screening measures correspondence analysis}
...
\addcontentsline{toc}{subsubsection}{Correlation analyses}
...
\addcontentsline{toc}{subsubsection}{Proportion and characterization of C/IE participants}
...
\break
\addcontentsline{toc}{section}{Supplementary Materials C - Clinical Study}
...
\addcontentsline{toc}{subsubsection}{Attention checks}
